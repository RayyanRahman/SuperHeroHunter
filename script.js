...
// to check the local storage if it has hero id's or not
function frvtHeros(){
    let hero;
...
// here async is used to clear list automatically.
function searchSuperHero(searchText,KCode1) {
    ...
    if (searchText.length > 0) {
        console.log('https://www.superheroapi.com/api.php/1358348604650444/search/' + searchText);
            // fetching the API objects with promises 1st .then is used to retrive data
